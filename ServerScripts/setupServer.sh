...
: ' 
This is the Docker Compose File for the same, feel free to change the Following Params
...
Run the Following Command in Terminal Start the Docker Compose File
NOTE: Need to be in the Direcotry where the compose file exists
'
...
cd /home
mkdir Neuralperk #what the fuck is nueral perk traces doing here paarth
